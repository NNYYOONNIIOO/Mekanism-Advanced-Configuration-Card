...
import com.nyonio.mekanism_advanced_configuration_card.proxy.CommonProxy;
...
public class MekConfigCardUpgradesMod {
    ...
    @SidedProxy(
        clientSide = "com.nyonio.mekanism_advanced_configuration_card.proxy.ClientProxy",
        serverSide = "com.nyonio.mekanism_advanced_configuration_card.proxy.CommonProxy"
    )
