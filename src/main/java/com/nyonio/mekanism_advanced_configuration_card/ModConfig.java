...
public class ModConfig {
    ...
    public static String[] upgradeSourcePriority = {"NETWORK", "CARD_SLOT_BAG", "PLAYER_INVENTORY"};
    ...
    @Config.RequiresMcRestart
    public static String[] upgradeReturnPriority = {"NETWORK", "CARD_SLOT_BAG", "PLAYER_INVENTORY"};
    ...
    private static void cleanInvalidConfigEntries() {
        ...
        try {
            ...
            String[] sourcePriority = config.getStringList("Upgrade Source Priority", "general", 
                new String[]{"NETWORK", "CARD_SLOT_BAG", "PLAYER_INVENTORY"}, 
            ...
            if (validSourcePriority.size() != sourcePriority.length) {
                config.get("general", "Upgrade Source Priority", new String[]{"NETWORK", "CARD_SLOT_BAG", "PLAYER_INVENTORY"}).set(validSourcePriority.toArray(new String[0]));
                changed = true;
            }
            ...
            if (validReturnPriority.size() != returnPriority.length) {
                config.get("general", "Upgrade Return Priority", new String[]{"NETWORK", "CARD_SLOT_BAG", "PLAYER_INVENTORY"}).set(validReturnPriority.toArray(new String[0]));
                changed = true;
            }
