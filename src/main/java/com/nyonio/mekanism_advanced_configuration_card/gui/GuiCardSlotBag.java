...
public class GuiCardSlotBag extends GuiContainer {
    ...
    public GuiCardSlotBag(InventoryPlayer playerInventory, ItemStack bagStack, int bagSlotIndex, boolean bagIsBaubles, int configCardSlotIndex) {
        super(new ContainerCardSlotBag(playerInventory, bagStack, bagSlotIndex, bagIsBaubles, configCardSlotIndex));
        xSize = 176;
        ySize = 166;
    }
